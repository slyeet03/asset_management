				...
				<div class="container-fluid container-fixed-lg bg-transparent">
					...
					<div class="panel panel-default">
						...
						<div class="pull-right">
							...
							<form action="BranchMasterDetail.htm" method="POST"
								id="SDC-FORM">
								...
								<td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');"><p><c:out value="${data.value.getBranchname()}"></c:out></p></td>
...
<script src="pages/js/BranchMasterGrid.js" type="text/javascript"></script>
...
<form action="UpdateBranchMaster.htm" method="POST" id="SDC1-FORM">
	 <input type="hidden" id="prev" name="prev" value="${prev}"> 
	 <input type="hidden" id="next" name="next" value="${next}">

...
public class AssetCategorymasterController {
  ...
  public @ResponseBody String AssetCategoryMasterDetail(@ModelAttribute AssetCategoryMaster assetCategoryMaster,
  ...
  @RequestMapping(value = "/AssetCategoryEditGrid.htm", method = RequestMethod.GET)
  public RedirectView AssetCategoryEditGrid(HttpServletRequest request, HttpServletResponse response,
      RedirectAttributes redirectAttributes) throws Exception {
    RedirectView rv = new RedirectView("GridView.htm");
    redirectAttributes.addFlashAttribute("page", "maker/AssetCategoryEditGrid");
    String recstatus = request.getParameter("recstatus");
    String prev = request.getParameter("prev");
    String next = request.getParameter("next");
    String Update = request.getParameter("Update");

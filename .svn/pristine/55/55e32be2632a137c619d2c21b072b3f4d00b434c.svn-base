...
<meta charset="utf-8" />
<title>INVESTMENT || BGL Master</title>
...
<body
			...
			<div class="content">
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							...
							<ul class="breadcrumb">
								...
								<li>Master</li>
								<li><a href="#" class="active">BGL Master</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg">
					<div class="row" id="rootwizard" >
						...
						<div class="panel-title p-l-10 p-t-10"><h4>BGL Master</h4></div>
								<div class="panel-body">
							<form:form class="" role="form" action="BGLMasterDetail.htm"
									modelAttribute="BGLMasterCommandname" id="SDC-FORM" name="SDC-FORM">
							
									<div class="row">
											<div class="col-sm-4">
													<div class="form-group form-group-default required">
														<label>BGL Number</label>
														 <form:input id="bglnumb" name="bglnumb" class="form-control bgl" 
															path="bglnumb" autocomplete="off" required="true" maxlength="20" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														<label>Description</label>
														<form:textarea id="bgldesc" name="bgldesc" class="form-control address"   onkeypress="return onlyAlphaNumeric(event,this);" 
															path="bgldesc" autocomplete="off" required="true" maxlength="50"/>
													</div>
												</div>
												<%-- <div class="col-sm-4">
													<div class="form-group form-group-default required">
														<label>Relation</label>
														<form:select class="full-width" data-init-plugin="select2" required="true"
															id="reporela" name="reporela" path="reporela">
															<form:option selected="selected" value="">Please Select</form:option>
														 	<c:forEach var="relation" items="${Paramast_reporela}">
																<form:option value="${relation.key}">${relation.value}</form:option>
															</c:forEach> 
														</form:select>
													</div>
										</div> --%>
	...
	<script src="assets/js/form_wizard.js" type="text/javascript"></script>
	 <script src="pages/js/BGLMaster.js" type="text/javascript"></script>

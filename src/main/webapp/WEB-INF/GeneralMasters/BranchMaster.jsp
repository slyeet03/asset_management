...
<meta charset="utf-8" />
<title>ASSET_MANAGEMENT || Branch Master</title>
...
<body
			...
			<div class="content">
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							...
							<ul class="breadcrumb">
								...
								<li>Master</li>
								<li><a href="#" class="active">Branch Master</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg">
					<div class="row" id="rootwizard" >
						<div class="panel panel-default" style="box-shadow: -2px 2px 2px #888888; border-radius: 7px;">
						<div class="panel-title p-l-10 p-t-10"><h4>Branch Master</h4></div>
								<div class="panel-body">
							<form:form class="" role="form" action="BranchMasterDetail.htm"
									modelAttribute="BranchMasterCommandname" id="SDC-FORM" name="SDC-FORM">
							
									<div class="row">
												<div class="col-sm-6">
													<div class="form-group form-group-default ">
														<label>Branchname</label>
														<form:input id="branchname" path="branchname"
												...
												<div class="col-sm-6">
													<div class="form-group form-group-default ">
														...
														<form:input id="branchcode" path="branchcode" value="${branchcode}" readonly="true"
															class="form-control " placeholder=""
															 autocomplete="off" />
													</div>
												</div>
												...
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														...
														<form:input id="firstaddress" path="firstaddress" class="form-control address" required="required" 
															autocomplete="off" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														...
														<form:textarea id="lastaddress" path="lastaddress" class="form-control address" required="required" 
															autocomplete="off"    />
													</div>
												</div>	
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														...
														<form:input id="pin" path="pin" class="form-control pincode"
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														...
														<form:input id="contactperson" path="contactperson" required="required"
														class="form-control "
															 autocomplete="off" 
											...
											<div class="row">
												<div class="col-sm-4">
													<div class="form-group form-group-default ">
														<label>Phone</label>
														<form:input id="conpersonphoneno" path="conpersonphoneno" class="form-control "
															 autocomplete="off" 
															cssStyle="cursor:pointer;" 
												...
												<div class="col-sm-4">
													<div class="form-group form-group-default required">
														...
														<form:input id="email" path="email" class="form-control email"
															required="required"  autocomplete="off" 
															maxlength="50" />
													</div>
												</div>																							
	...
	<script src="assets/js/form_wizard.js" type="text/javascript"></script>
	 <script src="pages/js/BranchMaster.js" type="text/javascript"></script>
	...
	<script type="text/javascript">var update = "${Update}";var disable1 = "${disable}"; var list ="${CIFNumber}"</script>
				...
				<div class="modal-content-wrapper">
					<div class="modal-content">
						<div class="modal-header clearfix text-left">
							<button type="button" class="close" id="close" name="close" data-dismiss="modal"
								aria-hidden="true">

...
<body
	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							...
							<ul class="breadcrumb">
								...
								<li>Asset SubCategory Management</li>
							...
							<div class="panel panel-default"
								...
								<div class="panel-body">
									<form:form class="" role="form"
										action="AssetSubCategoryMasterDetail.htm"
										modelAttribute="AssetSubcategorymastercommandname"
												...
												<div class="row">
														...
														<div class="form-group form-group-default required">
															...
															<form:select class="full-width"
																...
																<c:forEach var="catlist" items="${categoryList}">
																	<form:option value="${catlist.assetcategorycode}">${catlist.assetcategorycode}-${catlist.categorydescription}</form:option>
																</c:forEach>
															</form:select>
														</div>
													</div>
													<div class="col-sm-3">
														<div class="form-group form-group-default required">
															...
															<form:input id="subcategorycode" name="subcategorycode"
																value="${subcategorycode}" readonly="true"
																class="form-control number" required="true"
																path="subcategorycode" autocomplete="off" maxlength="10" />
														</div>
													</div>
													<div class="col-sm-5">
														<div class="form-group form-group-default required">
															<label>Sub Category Description</label>
															<form:input id="subcategorydescription"
																name="subcategorydescription" class="form-control"
																required="true" path="subcategorydescription"
																autocomplete="off" />
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-6">
														<div class="form-group form-group-default required">
															...
															<form:input id="subcategoryprefixcode"
																name="subcategoryprefixcode" class="form-control"
																required="true" path="subcategoryprefixcode"
																autocomplete="off" maxlength="10" />
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group form-group-default required">
															<label>Asset GL Head</label>
															<form:input id="assetglhead" name="assetglhead"
																class="form-control" required="true" path="assetglhead"
																autocomplete="off" />
														</div>
													</div>
												</div>
										...
										<input type="hidden" id="disable" name="disable"
											value="${disable}">
										<%-- <form:hidden id="subcategoryid" path="subcategoryid" value="${subcategoryid}" />--%>
			...
			<script src="pages/js/AssetSubCategorymaster.js"
				type="text/javascript"></script>
			<script type="text/javascript">
				var update = "${Update}";

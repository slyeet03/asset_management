...
<meta charset="utf-8" />
<title>ASSET MANAGEMENT || AssetDepartment Master</title>
...
<body
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							<ul class="breadcrumb">
								...
								<li>General</li>
								<li><a href="#" class="active">AssetDepartment Master</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg bg-transparent">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<form action="AssetDepartmentMasterDetail.htm" method="POST"
								id="SDC-FORM">
									...
									<table class="table table-hover demo-table-dynamic"
										...
										<thead>
											<tr>
												...
												<th style="width: 8%; color: #565656;">AssetDepartmentCode</th>
										...
										<td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');"><p><c:out value="${data.value.getDepartmentname()}"></c:out></p></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
	...
	<script src="pages/js/AssetDepartmentmasterGrid.js" type="text/javascript"></script>
	<script>var msg = "${successMsg}";</script>
			<%@ include file="/WEB-INF/master/Footer.jsp"%>
		</div>
	</div>

	<form action="UpdateAssetDepartmentMaster.htm" method="POST" id="SDC1-FORM">
	 <input type="hidden" id="prev" name="prev" value="${prev}"> 
	 <input type="hidden" id="next" name="next" value="${next}">

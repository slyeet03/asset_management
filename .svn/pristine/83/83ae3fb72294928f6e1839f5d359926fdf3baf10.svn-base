...
<meta charset="utf-8" />
<title>INVESTMENT || Asset Master</title>
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							<ul class="breadcrumb">
								...
								<li>General</li>
								<li><a href="#" class="active">Asset Master</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg bg-transparent">
					...
					<div class="panel panel-default">
						...
						<div class="pull-right">
							...
							<form action="AssetPurchaseDetail.htm" method="POST"
								id="SDC-FORM">
									...
									<table class="table table-hover demo-table-dynamic"
										...
										<thead>
											<tr>
												...
												<th style="width: 8%; color: #565656;">AssetName</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="data" items="${list_vc}">
												<tr>
													<td class="v-align-middle">
								                     ...
								                     <td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');">
								                     <p><c:out value="${data.value.getAssetname()}"></c:out></p></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
...
<script src="pages/js/AssetMasterGrid.js" type="text/javascript"></script>
...
<form action="UpdateAssetMaster.htm" method="POST" id="SDC1-FORM">
	 <input type="hidden" id="prev" name="prev" value="${prev}"> 
	 <input type="hidden" id="next" name="next" value="${next}">

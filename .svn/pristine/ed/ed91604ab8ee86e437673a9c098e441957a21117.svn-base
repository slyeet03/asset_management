...
<meta charset="utf-8" />
<title>ASSET_MANAGEMENT || BGL Master</title>
...
<body class="fixed-header windows desktop pace-done menu-pin menu-behind ">
	<!-- BEGIN SIDEBPANEL-->
					...
					<div class="panel panel-default">
					  ...
					  <!-- <div class="col-xs-12">
						<input type="text" id="search-table" class="form-control pull-right" placeholder="Search">
							...
							<form action="BGLMasterDetail.htm" method="POST"
								id="SDC-FORM">
									...
									<table class="table table-hover demo-table-dynamic"
										...
										<thead>
											<tr>
												...
												<th style="width: 8%; color: #565656;">BGL Number</th>
												<th style="width: 8%; color: #565656;">BGL Description</th>
												<!-- <th style="width: 8%; color: #565656;">Relation</th> -->
											</tr>
										</thead>
										<tbody>
													...
													<td class="v-align-middle">
														<div class="checkbox ">
															<input type="checkbox" id="${data.key}"
																name="recordid" value="${data.key}" />
																 <label for="${data.key}" style="position: static;"></label>
														</div>
													</td>
													<td class="v-align-middle" style="cursor: pointer;" onclick="filldetails(${data.key})"><p><c:out value="${data.value[0]}"/></p></td>
													<td class="v-align-middle" style="cursor: pointer;" onclick="filldetails(${data.key})"><p><c:out value="${data.value[1]}"/></p></td>
													<%-- <td class="v-align-middle" style="cursor: pointer;" onclick="filldetails(${data.key})"><p>${data.value[2]}</p></td> --%>
												</tr>
											</c:forEach>
										</tbody>
									</table>
							...
							<div class="btn-group  dropdown-default dropup" id="btngrp">
								<a class="btn btn-complete dropdown-toggle" data-toggle="dropdown" href="#"> Action <span class="caret"></span></a>
...
<script src="pages/js/BGLMasterGrid.js" type="text/javascript"></script>
...
<form action="UpdateBGLMaster.htm" method="POST" id="SDC1-FORM">
	 <input type="hidden" id="prev" name="prev" value="${prev}"> 
	 <input type="hidden" id="next" name="next" value="${next}">

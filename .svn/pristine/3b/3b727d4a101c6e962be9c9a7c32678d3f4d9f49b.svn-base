...
<meta charset="utf-8" />
<title>ASSET MANAGEMENT||Asset Department Master</title>
...
<body
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							...
							<ul class="breadcrumb">
								...
								<li><a href="#" class="active">Asset Department Master</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-md-9">
							<div class="panel panel-default"
								...
								<div class="panel-title p-l-10 p-t-10">
									...
									<h4>Asset Department Master</h4>
								</div>
								<div class="panel-body">
									<form:form class="" role="form" action="AssetDepartmentMasterDetail.htm"
										 modelAttribute="Assetdepartmentmastercommandname" id="SDC-FORM"
										name="SDC-FORM">
											...
											<div class="panel-body">
												<div class="row">
													<div class="col-sm-6">
														...
														id="branchid" name="branchid" path="branchid">
														<form:option selected="selected" value="">Please Select</form:option>
													    <c:forEach var="branchlist" items="${branchList}">
															 <form:option  value="${branchlist.branchcode}" >${branchlist.branchcode}-${branchlist.branchname}</form:option>
														</c:forEach>	 
													</form:select>
														</div>
													</div>
													<div class="col-sm-6">
														<div class="form-group form-group-default required">
															...
															<form:input id="branchname" name="branchname" class="form-control" required="true"
																path="branchname" autocomplete="off"/>
														</div>
													</div>
												</div>
												<div class="row">
													<div class="col-sm-6">
														...
														<form:input id="departmentcode" path="departmentcode" value="${assetDepartmentCode}" readonly="true"
													...
													<div class="col-sm-6">
														<div class="form-group form-group-default required">
															...
															<form:input id="departmentname" name="departmentname" class="form-control" required="true"
																path="departmentname" autocomplete="off"/>
														</div>
													</div>
												</div>
											</div>
									...
									<%-- <form:hidden id="assetcategoryid" path="assetcategoryid" value="${assetcategoryid}" /> --%>									
	...
	<script src="pages/js/AssetDepartmentmaster.js" type="text/javascript"></script>

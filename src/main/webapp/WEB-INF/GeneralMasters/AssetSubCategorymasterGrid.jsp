...
<meta charset="utf-8" />
<title>ASSET MANAGEMENT || Asset SubCategory Master</title>
...
<body
					...
					<div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
						<div class="inner">
							<ul class="breadcrumb">
								...
								<li>General</li>
								<li><a href="#" class="active">Asset SubCategory Master</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="container-fluid container-fixed-lg bg-transparent">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<form action="AssetSubCategoryMasterDetail.htm" method="POST"
								id="SDC-FORM">
									...
									<table class="table table-hover demo-table-dynamic"
										...
										<thead>
											<tr>
												...
												<th style="width: 8%; color: #565656;">AssetCategory</th>
												<th style="width: 8%; color: #565656;">AssetSubCategoryCode</th>
												<th style="width: 8%; color: #565656;">AssetSubCategoryDescription</th>
												<th style="width: 8%; color: #565656;">Sub Category Prefix</th>
											</tr>
										</thead>
										<tbody>
												...
												<tr>
													...
													<td class="v-align-middle">
														<div class="checkbox ">
															...
															<input type="checkbox" class="checkbox" id="${data.key}" name="recordid"
																value="${data.key}" /> <label for="${data.key}"
																style="position: static;"></label>
														</div>
													</td>
													
													<td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');"><p><c:out value="${data.value.categoryid}"></c:out></p></td>
													<td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');"><p><c:out value="${data.value.subcategorycode}"></c:out></p></td>
												    <td class="v-align-middle" style="cursor: pointer;" onclick="return filldetails('${data.key}');"><p><c:out value="${data.value.subcategorydescription}"></c:out></p></td>
													<td class="v-align-middle" style="cursor: pointer;" onclick="retrun filldetails('${data.key}');"><p><c:out value="${data.value.subcategoryprefixcode}"></c:out></p></td> 
												</tr>
											</c:forEach>
										</tbody>
									</table>
	...
	<script src="pages/js/AssetSubCategorymasterGrid.js" type="text/javascript"></script>
	<script>var msg = "${successMsg}";</script>
			<%@ include file="/WEB-INF/master/Footer.jsp"%>
		</div>
	</div>

	<form action="UpdateAssetSubCategoryMaster.htm" method="POST" id="SDC1-FORM">
	 <input type="hidden" id="prev" name="prev" value="${prev}"> 
	 <input type="hidden" id="next" name="next" value="${next}">

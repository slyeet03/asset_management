...
(function($) {
    ...
    $.Pages.init();
    setTimeout(() => {
		$(".page-sidebar, .scroll-element").css("visibility","visible");
	}, 1000);
    blink();
})(window.jQuery);
function blink(){
	setInterval(function() {
		setTimeout(function() {
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,1)");
		}, 200);
		setTimeout(function() {
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,0.8)");
			
		}, 400);
		setTimeout(function() {
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,0.6)");
		}, 600);
		
		setTimeout(function() {
			//Remove Light
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,0.4)");
		}, 800);
		setTimeout(function() {
			//Remove Light
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,0.2)");
		}, 1000);
		setTimeout(function() {
			//Remove Light
			$(".blinkLight").css("box-shadow","0px 0px 4px rgba(255,255,255,0)");
		}, 1200);
